...
import { addTenant, updateTenant } from "../services/firestore";
import { useProperties } from "../services/firestore";
import toast from "react-hot-toast";

const DEFAULT = {
  tenantName: "", phone: "", email: "", idProofNumber: "", assignedProperty: "",
  moveInDate: "", monthlyRent: "", securityDeposit: "", rentStatus: "Paid", tenantStatus: "Active",
};
...
export default function TenantModal({ tenant, onClose }) {
  ...
  useEffect(() => {
    if (tenant) setForm({ ...DEFAULT, ...tenant });
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select className="input" value={form.assignedProperty} onChange={e => set("assignedProperty", e.target.value)}>
